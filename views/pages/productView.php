...
<a href="../../controllers/logout.php" class="text-blue-600 font-semibold hover:underline">Logout</a>
...
<div class="font-sans p-4 mx-auto lg:max-w-6xl md:max-w-3xl">
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div class="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          ...
          <div class="p-2 flex-1 flex flex-col">
            <div class="flex-1">
              <h5 class="text-sm sm:text-base font-bold text-gray-800 truncate">ThreadCraft Vibes</h5>
              <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
              <div class="flex flex-wrap justify-between gap-2 mt-2">
                <div class="flex gap-2">
        ...
        <div class="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          ...
          <div class="p-2 flex-1 flex flex-col">
            <div class="flex-1">
              <h5 class="text-sm sm:text-base font-bold text-gray-800 truncate">Verbal Vogue Tees</h5>
              <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
              <div class="flex flex-wrap justify-between gap-2 mt-2">
                <div class="flex gap-2">
                  <h6 class="text-sm sm:text-base font-bold text-gray-800">$12</h6>
        ...
        <div class="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          ...
          <div class="p-2 flex-1 flex flex-col">
            <div class="flex-1">
              <h5 class="text-sm sm:text-base font-bold text-gray-800 truncate">Jargon Jungle</h5>
              <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
              <div class="flex flex-wrap justify-between gap-2 mt-2">
                <div class="flex gap-2">
        ...
        <div class="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all">
          ...
          <div class="p-2 flex-1 flex flex-col">
            <div class="flex-1">
              <h5 class="text-sm sm:text-base font-bold text-gray-800 truncate">Syllable Streetwear</h5>
              <p class="mt-1 text-gray-500 truncate">Teal Green Georgette Saree with Embroidery</p>
              <div class="flex flex-wrap justify-between gap-2 mt-2">
                <div class="flex gap-2">
                  <h6 class="text-sm sm:text-base font-bold text-gray-800">$14</h6>
