<div
      ...
      <div class="w-full max-w-lg bg-white shadow-lg relative ml-auto h-screen">
          ...
          <div class="space-y-4 mt-12">
            <div class="grid grid-cols-3 items-start gap-4">
              <div class="col-span-2 flex items-start gap-4">
                ...
                <div class="flex flex-col">
                  <h3 class="text-base max-sm:text-sm font-bold text-gray-800">Velvet Sneaker</h3>
              ...
              <div class="ml-auto">
                <h4 class="text-base max-sm:text-sm font-bold text-gray-800">$20.00</h4>
                <button type="button"
            ...
            <div class="grid grid-cols-3 items-start gap-4">
              <div class="col-span-2 flex items-start gap-4">
                ...
                <div class="flex flex-col">
                  <h3 class="text-base max-sm:text-sm font-bold text-gray-800">Smart Watch Timex</h3>
              ...
              <div class="ml-auto">
                <h4 class="text-base max-sm:text-sm font-bold text-gray-800">$60.00</h4>
                <button type="button"
                  class="mt-6 flex items-center px-3 py-1.5 border border-gray-300 text-gray-800 text-xs outline-none bg-transparent rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-2.5 fill-current" viewBox="0 0 124 124">
                    <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
            ...
            <div class="grid grid-cols-3 items-start gap-4">
              <div class="col-span-2 flex items-start gap-4">
                ...
                <div class="flex flex-col">
                  <h3 class="text-base max-sm:text-sm font-bold text-gray-800">French Connection</h3>
              ...
              <div class="ml-auto">
                <h4 class="text-base max-sm:text-sm font-bold text-gray-800">$40.00</h4>
                <button type="button"
                  class="mt-6 flex items-center px-3 py-1.5 border border-gray-300 text-gray-800 text-xs outline-none bg-transparent rounded-md">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-2.5 fill-current" viewBox="0 0 124 124">
                    <path d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z" data-original="#000000"></path>
            ...
            <div class="grid grid-cols-3 items-start gap-4">
              <div class="col-span-2 flex items-start gap-4">
                ...
                <div class="flex flex-col">
                  <h3 class="text-base max-sm:text-sm font-bold text-gray-800">Smart Watch</h3>
                  <p class="text-xs font-semibold text-gray-500 mt-0.5">Size: LG</p>
        ...
        <div class="p-4 absolute bottom-0 w-full border-t bg-white">
          <ul class="text-gray-800 divide-y">
            <li class="flex flex-wrap gap-4 text-lg font-bold">Subtotal <span class="ml-auto">$125.00</span></li>
          </ul>
          <button type="button" class="mt-6 text-sm font-semibold px-4 py-2.5 w-full bg-blue-600 hover:bg-blue-700 text-white rounded-md tracking-wide">Make Payment</button>
        </div>
      </div>
    </div>