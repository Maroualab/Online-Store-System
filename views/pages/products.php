...
<div class="relative font-[sans-serif] pt-[70px] h-screen">
  ...
  <div>
    <div class="flex items-start">
      ...
      <section class="main-content w-full overflow-auto p-6 flex flex-col gap-2">
        <button type="button" id="addProduct"
          class="w-[15%] self-end  px-5 py-2.5 rounded-lg text-sm tracking-wider font-medium border border-blue-700 outline-none bg-transparent hover:bg-blue-700 text-blue-700 hover:text-white transition-all duration-300">Add
          Product</button>
        ...
        <form class="py-3 px-6 text-sm" method="POST" action="" enctype="multipart/form-data" id="formInput">
          <div class="flex gap-2">
            ...
            <button id="closeModal"
              class="absolute top-2 right-2 text-gray-500 hover:text-gray-900 transition duration-300">
...
<script>
  ...
  //   await fetch("/online-store-system/controllers/usersControllers.php")
  //     .then(res => res.json())
  //     .then(data => {
  //       users = data;
  //       console.log(users);
